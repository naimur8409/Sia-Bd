        ...
        <div class="col-xl-12">
            <div class="card" style="border:1px solid #0d0d0e">
                <div class="card-header" style="background-color: #0d0d0e">
                    <h4 class="text-white">Accounts Head Create Form</h4>
                </div>
                <div class="card-body">
        ...
        <div class="col-12">
            <div class="card" style="border:1px solid #ea1b23">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('account.head.store')}}" style="border:1px solid #ea1b23">
                        @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="customControlValidation1" name="type" value="0">
                                                <label class="custom-control-label" for="customControlValidation1">Income</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="customControlValidation2" name="type" value="1">
