                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="{{route('dashboard')}}">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="{{asset('template')}}/assets/images/logo-icon-sia.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                            ...
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{asset('template')}}/assets/images/siaName.JPG" alt="homepage" class="dark-logo" style="max-width:180px;" />
                                <!-- Light Logo text -->
